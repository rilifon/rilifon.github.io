...
class ApplicationMain {
	...
	public static function main() {
		...
		//flash.Lib.setPackage("HaxeFlixel", "marvellous", "com.example.myapp", "0.0.1");
		...
		urlLoaders.set("assets/data/text/index/main.txt", urlLoader);
		total ++;
		...
		loaders.set("assets/images/banner.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/construction.jpg", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/covers/naomi/naomi.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/covers/naomi/star.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/covers/psycho/ball.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/covers/psycho/psycho.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/dialog.png", loader);
		total ++;
